...
<html class="ie ie8" lang="en">
   ...
   <html class="ie ie9" lang="en">
      ...
      <html lang="en">
         <!--<![endif]-->
         <!-- Mirrored from 2code.info/demo/html/ask-me-html/blog_2_full_width.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Dec 2016 07:06:29 GMT -->
         <head>
            <meta charset="utf-8">
             ...
             <?php include('log.php'); ?>
               ...
               <div class="breadcrumbs">
                  <section class="container">
                     <div class="row">
                        <div class="col-md-12">
                           <h1>Blog 2 full width</h1>
                        </div>
                        <div class="col-md-12">
                           <div class="crumbs">
                              <a href="#">Home</a>
                              <span class="crumbs-span">/</span>
                              <span class="current">Blog 2 full width</span>
                           </div>
                        </div>
                     </div>
                  </section>
