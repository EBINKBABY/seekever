...
<html class="ie ie8" lang="en">
   ...
   <html class="ie ie9" lang="en">
      ...
      <html lang="en">
         <!--<![endif]-->
         <!-- Mirrored from 2code.info/demo/html/ask-me-html/single_post_l_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Dec 2016 07:06:29 GMT -->
         <head>
            <meta charset="utf-8">
               ...
               <div id="header-top">
                  <section class="container clearfix">
                     <?php include('nav2.php'); ?>
                      <?php include('searchbpx.php'); ?>
                     
                  </section>
               </div>
               <header id="header">
                  <section class="container clearfix">
                     <!--<div class="logo"><a href="index-2.html"><img alt="" src="images/logo.png"></a></div> -->RE
                     <?php include('nav.php'); ?>
                  </section>
               </header>
                     ...
                     <div class="col-md-9">
                        ...
                        <div id="commentlist" class="page-content">
                           <div class="boxedtitle page-title">
                              <h2>Comments ( <span class="color">5</span> )</h2>
                           </div>
