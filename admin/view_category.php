            ...
            <div id="wrap" class="grid_1200">
               ...
               <section class="container main-content page-left-sidebar">
                  <div class="row">
                     <div class="col-md-9">
                        <div class="page-content">
                           <table class="display table table-striped table-bordered" border="15" cellpadding="1" cellspacing="1">
                              <thead>
                              <tr>
                                 <th> Sl.No   </th>
                                 <th>      Category Name    </th>
                              ...
                              <tbody>
                                 ...
                                 $count = 1;
                                    while ($row=mysqli_fetch_assoc($result)) {
                                     ...
                                     echo "<td>". "<a class=\"button small blue-button\" href=\"edit_category.php?id=".$row['id']."\">" . "Edit</a></td>";
                                     echo "<td>". "<a class=\"button small blue-button\" href=\"delete_category.php?id=".$row['id']."\">" . "Delete</a></td>";
