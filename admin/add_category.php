...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])){
   ...
   $desc = $_POST['desc'];
   $sql = "INSERT INTO categories(name,descr) VALUES('$catname','$desc')";
   $result = sqlexec($sql);
   if($result){
                           ...
                           <form class="form-style form-style-3 form-style-5" method="POST" action="">
                                    <div class="form-inputs clearfix">
                                       <p>
                                          ...
                                          <input type="text" name="catname" aria-required="true">
                                       </p>
                                     
                                    <div class="form-textarea">
                                       <p>
                                          <label class="required">Description<span>*</span></label>
                                          <textarea name="desc" aria-required="true" cols="58" rows="5"></textarea>
                                       </p>
                                    </div>
                                    <p class="form-submit">
