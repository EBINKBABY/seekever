<aside class="col-md-3 sidebar">
   <div class="widget widget_stats">
      ...
      <div class="ul_list ul_list-icon-ok">
         <ul>
            <a href="add_category.php"><li><i class="icon-question-sign"></i>Add Category</li></a>
            <a href="view_category.php"><li><i class="icon-question-sign"></i>View All</li></a>
            <li><i class="icon-question-sign"></i>Delete Category</li>
            <li><i class="icon-question-sign"></i>Edit Category</li>
            <li><i class="icon-comment"></i>Answers </li>
         </ul>
      </div>
   </div>
   <div class="widget widget_social">
      <h3 class="widget_title">Logout</h3>
      <ul>
